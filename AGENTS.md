# AGENTS.md -- Capy Tab Manager: Setup & Onboarding Guide for Coding Agents

You're installing **Capy Tab Manager** for the user. Your job is not just to set it up -- it's to get them excited about using it.
...
> **Capy Tab Manager** replaces your new tab page with a clean dashboard of everything you have open, grouped by domain.
>
...
>
> You should see "Capy Tab Manager" appear in your extensions list.
...
> You're all set! Open a **new tab** and you'll see Capy Tab Manager.
>
> Here's how it works:
...
- Capy Tab Manager is a pure Chrome extension. No server, no Node.js, no npm.
